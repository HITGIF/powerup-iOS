...
![appstore](https://i.loli.net/2017/11/30/5a1fc0b27d3ce.png)
...
![fork](https://i.loli.net/2017/11/30/5a1fc23b45293.png)
...
![clone](https://i.loli.net/2017/11/30/5a1fc66a4b772.png)

---
4. Get the path where you have your git repository on your machine. Go to that path in Terminal using cd. Alternatively, Right click on project in Github Desktop and hit ‘Open in Terminal’. 

![terminal](https://i.loli.net/2017/11/30/5a1fc78fa13b6.png)
